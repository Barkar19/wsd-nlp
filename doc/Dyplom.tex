...
{\centering
{\fontsize{32pt}{36pt}\selectfont Systemy wizyjne}\\[0.5cm]
...
%%  Metadane dokumentu 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Eliminacja obiektów dynamicznych z sekwencji zdjęć o ustalonych parametrach kamery.}
\titleShort{Eliminacja obiektów dynamicznych}
